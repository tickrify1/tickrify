...
- ✅ `apps/backend/ENV_VARIABLES.md`
- ✅ `apps/backend/README_VERCEL.md`
- ✅ `apps/backend/DEPLOYMENT_CHECKLIST.md`
...
→ Leia `apps/backend/ENV_VARIABLES.md`

**Ver detalhes do deploy na Vercel:**
→ Leia `apps/backend/README_VERCEL.md`
...
4. **Variáveis:** `apps/backend/ENV_VARIABLES.md`
5. **Vercel:** `apps/backend/README_VERCEL.md`
