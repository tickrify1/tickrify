...
STRIPE_WEBHOOK_SECRET=whsec_xxxxx  # Será criado depois do deploy
```
...
- `apps/backend/ENV_VARIABLES.md` - Todas as variáveis de ambiente
- `apps/backend/README_VERCEL.md` - Guia detalhado Vercel
- `apps/backend/DEPLOYMENT_CHECKLIST.md` - Checklist de deploy
