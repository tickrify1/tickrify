...
5. Adicionar na Vercel: `STRIPE_WEBHOOK_SECRET=whsec_xxxxx`
...
3. **`apps/backend/ENV_VARIABLES.md`** - Todas as variáveis
4. **`apps/backend/README_VERCEL.md`** - Detalhes do Vercel
